...
func (w *lightPeerWrapper) RequestHeadersByHash(h common.Hash, amount, skip int, reverse bool) error {
	return w.peer.RequestHeadersByHash(h, amount, skip, reverse)
}

func (w *lightPeerWrapper) RequestHeadersByNumber(i uint64, amount, skip int, reverse bool) error {
